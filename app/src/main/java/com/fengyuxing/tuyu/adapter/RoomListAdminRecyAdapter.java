...
public class RoomListAdminRecyAdapter extends RecyclerView.Adapter<RoomListAdminRecyAdapter.ViewHolder> implements View.OnClickListener {
    ...
    public RoomListAdminRecyAdapter(Context context, List<DataList> datas) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.roomlist_admin_item, parent, false);
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView type_tv, title_tv, sex_tv, level_tv, remove_tv;
