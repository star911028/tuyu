...
public class CardLongClickWindow extends PopupWindow {
    ...
    public CardLongClickWindow(final Activity context, OnClickListener l) {
        this.context = context;
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        conentView = inflater.inflate(R.layout.card_longclick_window, null);
