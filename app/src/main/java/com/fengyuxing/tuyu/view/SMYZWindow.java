...
public class SMYZWindow extends PopupWindow {
    private final LinearLayout pop_layout;
    private final TextView ok_bt;
    ...
    public SMYZWindow(final Activity context, OnClickListener l) {
        this.context = context;
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        conentView = inflater.inflate(R.layout.smyz_window, null);
        ok_bt = (TextView) conentView.findViewById(R.id.ok_bt);
        pop_layout = (LinearLayout) conentView.findViewById(R.id.pop_layout);
        ok_bt.setTag(4);
        ok_bt.setOnClickListener(l);
