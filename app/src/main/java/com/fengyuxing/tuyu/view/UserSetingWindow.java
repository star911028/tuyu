...
public class UserSetingWindow extends PopupWindow {
    ...
    private TextView cancel_tv, take_black_tv, sendport_tv;
    ...
    public UserSetingWindow(final Activity context, OnClickListener l,Boolean isDeFriend) {
        this.context = context;
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        conentView = inflater.inflate(R.layout.user_setting_window, null);
        cancel_tv = (TextView) conentView.findViewById(R.id.cancel_tv);
        take_black_tv = (TextView) conentView.findViewById(R.id.take_black_tv);
        sendport_tv = (TextView) conentView.findViewById(R.id.sendport_tv);
        pop_layout = (LinearLayout) conentView.findViewById(R.id.pop_layout);
        cancel_tv.setTag(4);
        cancel_tv.setOnClickListener(l);
        take_black_tv.setTag(5);
        take_black_tv.setOnClickListener(l);
        sendport_tv.setTag(6);
        sendport_tv.setOnClickListener(l);
        if(isDeFriend){
            take_black_tv.setText("取消拉黑");
        }else {
            take_black_tv.setText("拉黑");
        }
