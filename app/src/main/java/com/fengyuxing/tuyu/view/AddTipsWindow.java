...
public class AddTipsWindow extends PopupWindow {
    ...
    public AddTipsWindow(final Activity context, OnClickListener l) {
        this.context = context;
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        conentView = inflater.inflate(R.layout.add_tips_window, null);
