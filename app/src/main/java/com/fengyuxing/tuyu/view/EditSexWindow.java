...
public class EditSexWindow extends PopupWindow {
    private final LinearLayout pop_layout;
    private final TextView canel_tv,sure_tv;
    ...
    public EditSexWindow(final Activity context, OnClickListener l) {
        this.context = context;
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        conentView = inflater.inflate(R.layout.editsex_window, null);
        canel_tv = (TextView) conentView.findViewById(R.id.canel_tv);
        sure_tv = (TextView) conentView.findViewById(R.id.sure_tv);
        pop_layout = (LinearLayout) conentView.findViewById(R.id.pop_layout);
        canel_tv.setTag(4);//放弃修改
        canel_tv.setOnClickListener(l);
        sure_tv.setTag(5);//确认修改
        sure_tv.setOnClickListener(l);
