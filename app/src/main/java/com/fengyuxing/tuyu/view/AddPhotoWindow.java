...
public class AddPhotoWindow extends PopupWindow {
    private final LinearLayout pop_layout;
    private TextView cancel_tv,take_photo_tv,pick_picture_tv;
    ...
    public AddPhotoWindow(final Activity context, OnClickListener l) {
        this.context = context;
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        conentView = inflater.inflate(R.layout.add_photo_window, null);
