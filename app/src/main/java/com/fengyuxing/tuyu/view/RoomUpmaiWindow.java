...
public class RoomUpmaiWindow extends PopupWindow {
    private final LinearLayout pop_layout;
    private TextView cancel_tv,boss_tv,normal_tv;
    ...
    public RoomUpmaiWindow(final Activity context, OnClickListener l) {
        this.context = context;
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        conentView = inflater.inflate(R.layout.room_upmai_window, null);
        cancel_tv = (TextView) conentView.findViewById(R.id.cancel_tv);
        boss_tv = (TextView) conentView.findViewById(R.id.boss_tv);
        normal_tv = (TextView) conentView.findViewById(R.id.normal_tv);
        pop_layout = (LinearLayout) conentView.findViewById(R.id.pop_layout);
        cancel_tv.setTag(4);
        cancel_tv.setOnClickListener(l);
        boss_tv.setTag(5);
        boss_tv.setOnClickListener(l);
        normal_tv.setTag(6);
        normal_tv.setOnClickListener(l);
