...
public class SetPhotoWindow extends PopupWindow {
    private final LinearLayout pop_layout;
    private TextView cancel_tv,take_photo_tv,pick_picture_tv,look_tv,delete_tv;
    ...
    public SetPhotoWindow(final Activity context, OnClickListener l) {
        this.context = context;
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        conentView = inflater.inflate(R.layout.set_photo_window, null);
        cancel_tv = (TextView) conentView.findViewById(R.id.cancel_tv);
        take_photo_tv = (TextView) conentView.findViewById(R.id.take_photo_tv);
        pick_picture_tv = (TextView) conentView.findViewById(R.id.pick_picture_tv);
        look_tv = (TextView) conentView.findViewById(R.id.look_tv);
        delete_tv = (TextView) conentView.findViewById(R.id.delete_tv);
        pop_layout = (LinearLayout) conentView.findViewById(R.id.pop_layout);

        look_tv.setTag(2);
        look_tv.setOnClickListener(l);
        delete_tv.setTag(3);
        delete_tv.setOnClickListener(l);
        cancel_tv.setTag(4);
        cancel_tv.setOnClickListener(l);
        take_photo_tv.setTag(5);
        take_photo_tv.setOnClickListener(l);
//        pick_picture_tv.setTag(5);
//        pick_picture_tv.setOnClickListener(l);
