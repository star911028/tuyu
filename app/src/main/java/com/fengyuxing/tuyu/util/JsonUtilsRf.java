...
public final class JsonUtilsRf {
		 ...
		 * @param defaultValue
		 * @return
		 * @see JsonUtilsRf#getLong(JSONObject, String, Long)
		 */
		public static long getLong(JSONObject jsonObject, String key, long defaultValue) {
		 ...
		 * @param defaultValue
		 * @return
		 * @see JsonUtilsRf#getLong(String, String, Long)
		 */
		public static long getLong(String jsonData, String key, long defaultValue) {
		 ...
		 * @param defaultValue
		 * @return
		 * @see JsonUtilsRf#getInt(JSONObject, String, Integer)
		 */
		 ...
		 * @param defaultValue
		 * @return
		 * @see JsonUtilsRf#getInt(String, String, Integer)
		 */
		 ...
		 * @param defaultValue
		 * @return
		 * @see JsonUtilsRf#getDouble(JSONObject, String, Double)
		 */
		public static double getDouble(JSONObject jsonObject, String key, double defaultValue) {
		 ...
		 * @param defaultValue
		 * @return
		 * @see JsonUtilsRf#getDouble(String, String, Double)
		 */
		public static double getDouble(String jsonData, String key, double defaultValue) {
...
//    }
		 ...
		 * <li>if jsonObject is null, return defaultValue</li>
		 * <li>if jsonData {@link JSONObject#JSONObject(String)} exception, return defaultValue</li>
		 * <li>return {@link JsonUtilsRf#getStringList(JSONObject, String, List)}</li>
		 * </ul>
		 */
		...
		public static JSONObject getJSONObject(JSONObject jsonObject, String key) {
			...
			return getJSONObject(jsonObject,key,jo);
		}
		 ...
		 * <li>if jsonData is null, return defaultValue</li>
		 * <li>if jsonData {@link JSONObject#JSONObject(String)} exception, return defaultValue</li>
		 * <li>return {@link JsonUtilsRf#getJSONObject(JSONObject, String, JSONObject)}</li>
		 * </ul>
		 */
...
//    }
		...
		public static JSONArray getJSONArray(JSONObject jsonObject, String key) {
			...
			return getJSONArray(jsonObject,key,defaultArray);
		}
		 ...
		 * <li>if jsonObject is null, return defaultValue</li>
		 * <li>if jsonData {@link JSONObject#JSONObject(String)} exception, return defaultValue</li>
		 * <li>return {@link JsonUtilsRf#getBoolean(JSONObject, String, Boolean)}</li>
		 * </ul>
		 */
...
//     * <li>return {@link JsonUtilsRf#parseKeyAndValueToMap(String)}</li>
//     * </ul>
//     */
//    public static Map<String, String> getMap(JSONObject jsonObject, String key) {
//        return JsonUtilsRf.parseKeyAndValueToMap(JsonUtilsRf.getString(jsonObject, key, null));
//    }
		 ...
		 * <li>return {@link JsonUtilsRf#getMap(JSONObject, String)}</li>
		 * </ul>
		 */
...
//     * <li>return {@link JsonUtilsRf#parseKeyAndValueToMap(JSONObject)}</li>
//     * </ul>
//     */
...
//    }
		 ...
		 * @since 1.0
		 */
		public static <T> T fromJson(String json, Class<T> clazz) throws JsonIOException, JsonSyntaxException {
			if (isBlank(json)) {
				return null;
			}
			GsonBuilder builder = new GsonBuilder();
		...
		public static String toJson(Object target, Type targetType,
			...
			try {
				...
				Log.d(JsonUtilsRf.class.getSimpleName(), "目标对象 " + target.getClass().getName()
		...
		public static <T> ArrayList<T> getObjectList(JSONArray arr, Class<T> clazz) {
			...
			for (int i = 0; i < arr.length(); i++) {
				T item = null;
				try {
					item = JsonUtilsRf.getObject(arr.getJSONObject(i), clazz);
				} catch (JSONException e) {
					e.printStackTrace();
				}
				list.add(item);
		...
		public static <T> ArrayList<T> getObjectList(JSONArray arr, String key, Class<T> clazz) {
			ArrayList<T> list = new ArrayList<T>();
			for (int i = 0; i < arr.length(); i++) {
				T item = null;
				try {
					JSONObject jsonObject = JsonUtilsRf.getJSONObject(arr.getJSONObject(i), key, null);
					item = JsonUtilsRf.getObject(jsonObject, clazz);
				} catch (JSONException e) {
					e.printStackTrace();
				}
				list.add(item);
		...
		public static <T> T getObject(String s, Class<T> clazz) throws JSONException{
			T t = JsonUtilsRf.fromJson(s, clazz);
			return t;
		}

		public static <T> T getObject(JSONObject object, Class<T> clazz) {
			try {
				T t = JsonUtilsRf.fromJson(object.toString(), clazz);
				return t;
			}catch (Exception e){
				return null;
			}
