...
//        updateAudioStreamType(AudioManager.STREAM_MUSIC);
    ...
    protected void playSuffix() {
        if (mSuffix) {
            ...
            mSuffixPlayer.setAudioStreamType(AudioManager.STREAM_MUSIC );// // 听筒播放 STREAM_VOICE_CALL            扬声器播放 STREAM_MUSIC
    ...
    Runnable playRunnable = new Runnable() {
        ...
        public void run() {
            ...
            currentAudioPlayer.start(AudioManager.STREAM_MUSIC );  // 听筒播放 STREAM_VOICE_CALL            扬声器播放 STREAM_MUSIC
        }
    };
